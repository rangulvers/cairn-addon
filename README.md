...
Einstellungen → Add-ons → Add-on Store → Dreipunkt-Menü → Repositories →
diese URL hinzufügen:

```
https://github.com/rangulvers/cairn-addon
```

Danach erscheint **Cairn** im Store.

## Add-ons in diesem Repository

| Add-on | Beschreibung |
|---|---|
| [Cairn](./cairn) | Haushalts-Inventar mit Geräte-Import aus Home Assistant |
